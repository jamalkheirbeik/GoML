...
func main() {
	...
	nn := network.NewNeuralNetwork(arch.NewArch(2, 2, 1), network.Relu, network.Sigmoid)
	nn.Randomize(-1, 1)
	...
	nn.Train(dataset, EPOCHS, LEARNING_RATE, THRESHOLD, MAX_RATE_REDUCTIONS, MAX_DECLINE)
